...
public:
  FiddleContextMetalPLS(FiddleContextOptions fiddleOptions)
    ...
    metalOptions.shaderCompilationMode = m_fiddleOptions.shaderCompilationMode;
  ...
  void flushPLSContext(RenderTarget *offscreenRenderTarget) final {
    ...
    m_renderContext->flush({
        .renderTarget = offscreenRenderTarget != nullptr ? offscreenRenderTarget
                                                         : m_renderTarget.get(),
...
FiddleContext::MakeMetalPLS(FiddleContextOptions fiddleOptions) {
